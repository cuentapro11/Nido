...
const CATEGORY_COLORS: Record<string, { bg: string; text: string; dot: string }> = {
  'Bebés':       { bg: 'bg-blue-50',   text: 'text-blue-700',   dot: 'bg-blue-400' },
  'Caminadores': { bg: 'bg-indigo-50', text: 'text-indigo-700', dot: 'bg-indigo-400' },
  'Pre-escolar': { bg: 'bg-sky-50',    text: 'text-sky-700',    dot: 'bg-sky-400' },
};
