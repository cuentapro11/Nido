  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="flex items-center justify-between px-4 pt-10 pb-3">
        <div>
          <p className="text-[11px] font-semibold text-muted-foreground uppercase tracking-widest">Cuido Rayito de Sol ☀️</p>
          <h1 className="text-2xl font-extrabold text-foreground leading-tight mt-0.5">Inicio</h1>
        </div>
